...
@Component({
  ...
  template: `
    <div class="w-full max-w-3xl mx-auto min-h-screen pb-safe relative overflow-x-hidden">
      ...
      @if (showStickyHeader()) {
        <div class="sticky top-0 z-[20] pt-[max(env(safe-area-inset-top),1rem)] pb-4 px-5 border-b border-white/5 bg-base-200/60 sm:bg-base-200/40 sm:backdrop-blur-[24px] backdrop-blur-0 transition-all duration-300">
            <ng-content select="[header]"></ng-content>
        </div>
      }
      <div class="px-4 sm:px-5 pb-24">
